...
<a href="/matelas" class="text-gray-500 flex gap-2 mb-3">
    ...
    <form method="post">
        {{-- Ajouter impérativement le csrf pour question de sécurité--}}
        @csrf

        <div class="mb-3">
            <label for="brand" class="block mb-1">Marque</label>
            <input type="text" name="brand" id="brand" value="{{ old('brand') }}" class="rounded-lg">
        </div>

        <div class="mb-3">
            <label for="description" class="block mb-1">Modèle</label>
            <textarea name="description" id="description" class="rounded-lg">{{ old('description') }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="price" id="price" value="{{ old('price') }}" class="rounded-lg">
        </div>
